...
# ======================================================================
# --- 📝 COMMAND HANDLERS (FIXED: Using HTML for stability) ---
# ======================================================================
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Text changed to use HTML for stability (resolves dash '-' escaping issue)
    start_text = (
...
async def timer_status_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Using Markdown V2 and escaping the dash manually for the separator
    text = (
        ...
        f"\\-\\- **Active Games** \\-\\- \n" # Escaping dashes in the separator
